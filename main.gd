...
const MODELS := ["res://models/puzzle.glb", "res://models/chariot.glb", "res://models/clover.glb", "res://models/ball.glb", "res://models/whale.glb", "res://models/spider.glb", "res://models/planet.glb"]
