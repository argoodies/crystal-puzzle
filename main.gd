...
const MODELS := ["res://models/puzzle.glb", "res://models/chariot.glb", "res://models/clover.glb", "res://models/ball.glb", "res://models/bottle.glb", "res://models/whale.glb", "res://models/dragon.glb", "res://models/planet.glb"]
